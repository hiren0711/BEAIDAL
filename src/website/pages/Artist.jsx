                            ...
                            <div className="w3breadcrumb-gids">
                                ...
                                <div className="w3breadcrumb-right">
                                    <ul className="breadcrumbs-custom-path">
                                        ...
                                        <li className="active"><span className="fas fa-angle-double-right mx-2" />Artist</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            {artist && artist.map((item) => (
                                <div className='artist-card' key={item.id}>
                                    <div className='artist_img'>
                                        <img src={item.profile_img} alt="artist img" />
                                    </div>
                                    <div className='artist_content '>
                                        <h4 className='artist_name '>{item.name}</h4>
                                        <div className='d-flex justify-content-between align-items-center'>
                                            <h6 className='artist_time my-2'>{item.timming}</h6>
                                            <h3 className='artist_price my-2'>{item.price}</h3>
                                        </div>
                                        <Link to={`/artist/${item.id}`} className='btn btn-primary'>View Artist</Link>
                                    </div>
                                </div>))}
